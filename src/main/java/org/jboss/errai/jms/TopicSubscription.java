...
/**
 * Listens on a JMS Topic and forward message to Errai. Supported JMS messages type is
      ...
      topicSubscriber.setMessageListener(new MessageListener() {
        public void onMessage(javax.jms.Message message) {
          ...
          if (message instanceof MapMessage) {
            // addressing
            MessageBuildParms<MessageBuildSendableWithReply> parms =
                MessageBuilder.createMessage().toSubject("jms:" + binding.getTopicName())
                    .signalling();
            try {
